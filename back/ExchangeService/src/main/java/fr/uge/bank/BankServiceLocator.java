...
public class BankServiceLocator extends org.apache.axis.client.Service implements fr.uge.bank.BankService {
    ...
    private java.lang.String Bank_address = "http://localhost:8080/Bank/services/Bank";
    ...
    public fr.uge.bank.Bank getBank(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.bank.BankSoapBindingStub _stub = new fr.uge.bank.BankSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.bank.Bank.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.bank.BankSoapBindingStub _stub = new fr.uge.bank.BankSoapBindingStub(new java.net.URL(Bank_address), this);
                _stub.setPortName(getBankWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://bank.uge.fr", "BankService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://bank.uge.fr", "Bank"));
        }
